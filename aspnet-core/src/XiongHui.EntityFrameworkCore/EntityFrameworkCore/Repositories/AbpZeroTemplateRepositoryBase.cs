...
namespace XiongHui.EntityFrameworkCore.Repositories
{
    ...
    public abstract class AbpZeroTemplateRepositoryBase<TEntity, TPrimaryKey> : EfCoreRepositoryBase<XiongHuiDbContext, TEntity, TPrimaryKey>
        where TEntity : class, IEntity<TPrimaryKey>
    {
        protected AbpZeroTemplateRepositoryBase(IDbContextProvider<XiongHuiDbContext> dbContextProvider)
